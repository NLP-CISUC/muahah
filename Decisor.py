...
from decisionMakingStrategies.BordaStrategy import BordaStrategy
...
class Decisor:
    ...
    def bestAnswerByStrategy(self, query, defaultAgentsAnswers, externalAgentsAnswers, query_labels):
        ...
        all_strategies = {"SimpleMajority": SimpleMajority, "PrioritySystem": PrioritySystem,
                        ...
                        "query_answer": query_answer, "YesNoStrategy": YesNoStrategy, "OrStrategy": OrStrategy, "BordaStrategy": BordaStrategy}
        ...
        extra_args_by_strategy = { "query_agent": [query_labels, self.agents_dict],
                                ...
                                "YesNoStrategy": [query], "OrStrategy": [query], "BordaStrategy": [query]}
